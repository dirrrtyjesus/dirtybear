...
git clone https://github.com/dirrrtyjesus/dirtybear  # Clone the repository
cd dirtybear  # Navigate to the project directory
...
``` bash
git clone https://github.com/dirrrtyjesus/dirtybear.git 
cd dirtybear
chmod +x build.sh
```
